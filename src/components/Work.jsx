      ...
      <section className="grid gap-12 mt-12 sm:grid-cols-3">
        <article>
          ...
          <h3 className="text-xl font-semibold mb-4">
            <span className="text-green-500 font-semibold">Google</span>, Interaction Designer
          </h3>
          <p className="text-sm">
        ...
        <article>
          ...
          <h3 className="text-xl font-semibold mb-4">
            <span className="text-blue-500 font-semibold">Facebook</span>, Product Designer
          </h3>
          <p className="text-sm">
        ...
        <article>
          ...
          <h3 className="text-xl font-semibold mb-4">
            <span className="text-pink-500 font-semibold">Dribbble</span>, Graphic Designer
          </h3>
          <p className="text-sm">
